...
class RGBDAugmentor:
    ...
    def spatial_transform(self, images, depths, depths_valid, poses, intrinsics):
    ...
    def __call__(self, images, poses, depths, depths_valid, intrinsics):
        images = self.color_transform(images)
        return self.spatial_transform(images, depths, depths_valid, poses, intrinsics)